aws s3 cp --only-show-errors  s3://ncc-otsuka-clinseq/data/fastq/NALM6_R1.fastq /scratch/AWS_DATA/ncc-otsuka-clinseq/data/fastq/NALM6_R1.fastq
aws s3 cp --only-show-errors  s3://ncc-otsuka-clinseq/data/fastq/NALM6_R2.fastq /scratch/AWS_DATA/ncc-otsuka-clinseq/data/fastq/NALM6_R2.fastq
