...
export BWA_OPTION="-T 0 -K 100000000 -Y -t 16"
export SAMTOOLS_VIEW_OPTION="-Sbhu --threads 16"
export SAMBAMBA_VIEW_OPTION="-l 0 -S -h --format=bam -t 16"
export SAMTOOLS_SORT_OPTION="-n -l 0 --threads 16 -T /scratch/5959_tumor"
export SAMBAMBA_SORT_OPTION="-n -u --tmpdir /scratch/ -t 16"
export BIOBAMBAM_OPTION="level=0 inputformat=sam outputformat=bam outputthreads=16 tmpfile=/scratch/5929_tumor SO=queryname"
export TOOL_COMBINATION="1"
export EVAL_CONDITION="bwa mem | samtools view | samtools sort (t=16,16,16) (comp=no)"
