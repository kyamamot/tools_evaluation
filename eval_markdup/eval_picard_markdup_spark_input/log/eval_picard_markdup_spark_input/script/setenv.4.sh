...
export S3_INPUT_BAM="s3://keisuke-nccj-otsuka/sample/exome/5929_tumor_100/bam/5929_tumor.samblaster_matetag.sort.bam"
export INPUT_BAM="/scratch/AWS_DATA/keisuke-nccj-otsuka/sample/exome/5929_tumor_100/bam/5929_tumor.samblaster_matetag.sort.bam"
...
export EVAL_CONDITION="compress.possort.bam"
