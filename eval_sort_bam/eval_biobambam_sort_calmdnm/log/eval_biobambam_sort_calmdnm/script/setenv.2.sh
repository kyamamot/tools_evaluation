...
export SORT_OPTION="inputformat=sam outputformat=bam outputthreads=15 calmdnm=1 calmdnmrecompindetonly=1"
export EVAL_CONDITION="calmdnm=1,calmdnmrecompindetonly=1"
