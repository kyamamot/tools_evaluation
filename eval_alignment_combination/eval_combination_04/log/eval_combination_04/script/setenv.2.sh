...
export SAMTOOLS_VIEW_OPTION="-Sbhu --threads 4"
export SAMBAMBA_VIEW_OPTION="-S -h --format=bam -t 4"
export SAMTOOLS_SORT_OPTION="-n --threads 4 -T /scratch/5959_tumor"
export SAMBAMBA_SORT_OPTION="-n --tmpdir /scratch/ -t 4"
export BIOBAMBAM_OPTION="inputformat=sam outputformat=bam outputthreads=4 tmpfile=/scratch/5929_tumor SO=queryname"
export TOOL_COMBINATION="2"
export EVAL_CONDITION="bwa mem | Sambamba view | Sambamba sort (t=8,4,4) (comp=yes)"
